            ...
            try:
                ...
                if frame_data:
                    ...
                    if frame is not None:
                        ...
                        self.logger.info(f"Frame {sequence_number}: Successfully reassembled and buffered")
                    else:
...
class MultiStreamReceiver:
    ...
    def start_http_server(self):
                    ...
                    for stream_name, stream in self.server.receiver.streams.items():
                        ...
                        html += f"""
                            <div class="stream">
                                ...
                                <a href="/{stream_name}/stats">Statistics</a>
                            </div>
                        """
                ...
                # Stream landing pages
                    ...
                    <html>
                        ...
                        <body>
                            ...
                            <p><a href="/{stream_name}/stats">Statistics</a> | <a href="/">Back to Streams</a></p>
                        </body>
                    </html>
                    """
                    self.wfile.write(html.encode())
        ...
        self.http_server = HTTPServer((http_config['http_host'], http_config['http_port']), StreamHandler)
